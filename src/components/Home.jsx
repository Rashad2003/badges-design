...
function Home() {
    ...
    return (
        <div className="max-w-[1200px] mx-auto px-8 min-h-screen animate-in fade-in duration-500">
            ...
            <main>
                ...
                <section className="text-center mb-20 flex flex-col items-center">
                    ...
                    <div>
                        <Link to="/student/alex-123" className="text-slate-500 hover:text-slate-300 text-sm underline">
                            View Demo Student Profile (alex-123)
                        </Link>
                    </div>
                </section>
                ...
                <section className="mb-20">
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        <div onClick={() => { setSelectedBadge({ type: 'bronze', title: 'Python Basic', xp: 100, top: '25%', icon: FaPython }); setIsBadgeModalOpen(true); }} className="cursor-pointer flex-1 min-w-[250px] max-w-[350px]">
                            <BadgeCard type="bronze" icon={FaPython} title="Python Basic" tier="Bronze Tier" />
                        </div>
                        <div onClick={() => { setSelectedBadge({ type: 'silver', title: 'JS Intermediate', xp: 300, top: '10%', icon: FaJs }); setIsBadgeModalOpen(true); }} className="cursor-pointer flex-1 min-w-[250px] max-w-[350px]">
                            <BadgeCard type="silver" icon={FaJs} title="JS Intermediate" tier="Silver Tier" />
                        </div>
                        <div onClick={() => { setSelectedBadge({ type: 'gold', title: 'React Master', xp: 500, top: '5%', icon: FaReact }); setIsBadgeModalOpen(true); }} className="cursor-pointer flex-1 min-w-[250px] max-w-[350px]">
